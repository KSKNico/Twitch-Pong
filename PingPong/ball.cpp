...
Ball::Ball(sf::RenderWindow &window_, float size_, sf::Vector2f speed_, Stage &stage_, Player &player1_,
           Player &player2_)
    : window{window_}, size{size_}, speed{speed_}, player1{player1_}, player2{player2_}, stage{stage_} {
